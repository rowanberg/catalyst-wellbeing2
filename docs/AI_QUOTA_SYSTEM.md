...
## Overview
The AI quota system provides users with 75 total daily AI requests:
- **30 Standard Requests**: Using Gemini 2.0 Flash (fastest)
- **45 Extra Requests**: Using other Gemini models (1.5 Pro, 1.5 Flash, 1.0 Pro)
...
2. **Next 45 requests/day**: Routes through tiered Gemini models (extra quota):
...
- Next 45 requests: "X extra requests remaining today" 
