      ...
      if (!functionError && functionResult) {
        ...
        if (assignedClasses && assignedClasses.length > 0) {
          ...
          try {
            ...
            // Classes table query failed - continue to fallback
          }
          ...
          if (classError || !classDetails) {
            try {
              ...
              // Simple query also failed - continue to fallback
            }
          }
          ...
          if (!classError && classDetails) {
            ...
            logger.error('Failed to fetch class details from classes table', classError)
