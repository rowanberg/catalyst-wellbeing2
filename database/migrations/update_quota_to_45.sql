-- ============================================
-- Update AI Quota System: 500 -> 45 Extra Requests
-- ============================================
-- This migration updates the quota limit from 500 to 45 extra requests/day

-- Drop existing functions (required due to return type change)
...
-- Recreate get_or_create_user_quota with updated limits
...
-- Recreate increment_user_quota with updated limits
